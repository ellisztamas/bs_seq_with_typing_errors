...
# Data from Columbia
col0_files <- Sys.glob("03_analysis/02_errors_on_reads/output/Col0*positions.csv")
...
fly_files <- Sys.glob("03_analysis/02_errors_on_reads/output/Fly*positions.csv")
...
lambda_files <- Sys.glob("03_analysis/02_errors_on_reads/output/lambda_*positions.csv")
