...
# This script is for the Columbia samples only.
# 
# Tom Ellis, 30th October 2023

#SBATCH --job-name=col0_cxreport
...
files=(02_processing/03_filter_dubious_reads/filtered/Col0_*.bam)
infile=${files[$SLURM_ARRAY_TASK_ID]}

outdir=02_processing/03_filter_dubious_reads/reports
genome_folder=02_processing/01_prepare_genomes/col0
