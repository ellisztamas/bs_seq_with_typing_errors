...
#SBATCH --output=02_processing/02_align_reads/columbia/slurm/%x-%a.out
#SBATCH --error=02_processing/02_align_reads/columbia/slurm/%x-%a.err
#SBATCH --time=1-00:00
#SBATCH -N 1
...
# output directory
outdir=02_processing/02_align_reads/columbia/output

# Sample sheet giving sample name and paths to the two fastq files
sample_sheet=02_processing/02_align_reads/columbia/col0_sample_sheet.csv
# Get the sample name
...
genome=02_processing/01_prepare_genomes/col0/dm6_plus_vectors_microbiome.fa
