...
#SBATCH --output=03_processing/02_align_reads/drosophila/slurm/%x-%a.out
#SBATCH --error=03_processing/02_align_reads/drosophila/slurm/%x-%a.err
#SBATCH --time=1-00:00
#SBATCH -N 1
...
# output directory
outdir=03_processing/02_align_reads/drosophila/output

# Sample sheet giving sample name and paths to the two fastq files
sample_sheet=03_processing/02_align_reads/drosophila/drosophila_sample_sheet.csv
# Get the sample name
...
genome=03_processing/01_prepare_genomes/drosophila/dm6_plus_vectors_microbiome.fa
